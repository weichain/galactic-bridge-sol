...
const programId = new PublicKey('HS6NTv6GBVSLct8dsimRWRvjczJTAgfgDJt8VpR8wtGm');
...
const provider = new anchor1.AnchorProvider(connection, wallet, anchor1.AnchorProvider.defaultOptions());
